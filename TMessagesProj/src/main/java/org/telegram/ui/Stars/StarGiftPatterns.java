...
public class StarGiftPatterns {
    ...
    private static final float[] dynamicProfile = new float[]{
            -130f, 0f, 16f, 0.14f, 0.7f,
            130f, 0f, 16f, 0.18f, 0.7f,

            -50f, -72f, 16f, 0.13f, 0.7f,
            50f, -72f, 16f, 0.10f, 0.7f,

            -50f, 72f, 19f, 0.27f, 0.7f,
            50f, 72f, 19f, 0.25f, 0.7f,

            - 110f, 50f, 19f, 0.41f, 1.0f,
            110f, 50f, 19f, 0.40f, 1.0f,

            -110f, -50f, 17f, 0.36f, 1.0f,
            110f, -50f, 17f, 0.39f, 1.0f,

            -80f, 0f, 19f, 0.34f, 1.0f,
            80f, 0f, 19f, 0.33f, 1.0f,

            0, -60f, 19f, 0.5f, 1.0f,
            0, 60f, 19f, 0.5f, 1.0f,

            -50f, -35f, 19f, 0.43f, 1.0f,
            50f, -35f, 19f, 0.40f, 1.0f,

            -50f, 35f, 19f, 0.47f, 1.0f,
            50f, 35f, 19f, 0.41f, 1.0f
    };
